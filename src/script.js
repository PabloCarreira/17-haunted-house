...
const gravesGeometry = new THREE.BoxGeometry(.6,.8,.2)
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime*.6))
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime*.9))
    ghost3.position.y = Math.sin(elapsedTime*5) + Math.sin(elapsedTime)
